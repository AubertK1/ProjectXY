...
public class Cyborg extends Fighter{
    ...
    public Cyborg(float x, float y, Player player) {
        ...
        idleAnimation.setHitboxes(new Rectangle(31, 17, 2, 6),
                new Rectangle(31, 17, 4, 6),
                new Rectangle(31, 17, 6, 6),
                new Rectangle(31, 17, 10, 6));

        Texture runSheet = new Texture("assets\\textures\\Violet_Cyborg\\Violet_Cyborg_Running_Sheet.png");
        runAnimation = animate(runSheet, 2, 3, .075f);

        jumpAnimation = animate(new Texture("assets\\textures\\Violet_Cyborg\\Violet_Cyborg_Jumping_Sheet.png"), 1, 1, .5f);
        fallAnimation = animate(new Texture("assets\\textures\\Violet_Cyborg\\Violet_Cyborg_Falling_Sheet.png"), 3, 2, .15f);
    }
}
